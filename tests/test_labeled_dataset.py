import unittest
import pandas as pd
from milliontrees.datasets.base.labeled import LabeledDataset

class TestLabeledDataset(unittest.TestCase):
    
    def setUp(self):
        self.dataset = LabeledDataset(root_dir='path/to/data', split_scheme='official')
    ...
    def test_process_splits(self):
        ...
        self.assertEqual(self.dataset._split_array.tolist(), [0, 1, 2, 0])  # Assuming split_dict is correct
